...
//feeder Mechanism
private final CAN feederMotor = new CAN(2);

//intake Mechanism
private final CAN intakeMotor = new CAN(3);

//Shooter Mechanism
private final CAN shooterMotor = new CAN(4);

//Hanging Arm
private final CAN hangingMotor = new CAN(5);
